...
@interface AvailableForChatViewController : UIViewController <UIAlertViewDelegate, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, QBActionStatusDelegate, QBChatDelegate>{
