...
#import "AvailableForChatViewController.h"
#import "DataManager.h"
#import "ChatViewController.h"
@interface AvailableForChatViewController ()

@end

@implementation AvailableForChatViewController
@synthesize users;
...
- (void)startChat{
    ...
    if(![self.selectedUsers count]){
        ...
        ChatViewController *chatViewController = [storyboard instantiateViewControllerWithIdentifier:@"ChatVC"];
